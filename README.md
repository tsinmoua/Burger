...
## Description 
A fun application to keep track of all the burgers you have ate or going to eat. This utilizes an ORM file structure.
...
Enter in the burger name you want to eat in the input box, and add it! It will pop up on the left side. You can eat it by clicking on the burger icon next to it. Once eaten, it will show up on the right side.  
